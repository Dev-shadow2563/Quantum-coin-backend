...
db.serialize(() => {
  ...
  const initialMessages = [
    [1, 'CryptoKing', 'Just made $500 profit on DOGE! This platform is amazing!'],
    [1, 'MoonShot', 'Loving the live charts! Much better than other exchanges'],
    [1, 'DiamondHands', 'Successfully withdrew $2,500! Process was smooth'],
    [1, 'BitcoinQueen', 'Lost $200 on ADA but learned my lesson. Trying again!'],
    [1, 'TraderPro', 'The UI is so clean! Best trading experience I\'ve had']
  ];
